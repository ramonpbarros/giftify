    ...
    try {
      await Product.bulkCreate([
        ...
        },
        {
          ...
          productName: 'Soccer Ball',
          productDescription:
            '(6) A recreational soccer ball with a resilient butyl bladder for casual games',
          productImgUrl:
            'https://m.media-amazon.com/images/I/61ESBrdZUxL._AC_SY879_.jpg',
          productPrice: 18.0,
          productLink:
        ...
        },
        {
          ...
          productName: 'Umbrella',
          productDescription:
            '(6) Compact umbrella for travel: easily portable, our travel umbrella weighs 15 oz and folds down to a mere 11.5" (29cm). It works great as a pocket umbrella, small umbrella for purse, and car umbrella',
          productImgUrl:
            'https://m.media-amazon.com/images/I/61H9y1lX+NL._AC_SY879_.jpg',
          productPrice: 26.99,
          productLink:
        ...
        },
        {
          ...
          productName: 'Expresso Maker',
          productDescription:
            '(6) The original moka coffee pot: Moka Express is the original stovetop espresso maker, it provides the experience of the real Italian way of preparing a tasteful coffee, its unique shape and the inimitable gentleman with moustache date back to 1933, when Alfonso Bialetti invented it.',
          productImgUrl:
            'https://m.media-amazon.com/images/I/51+I23YIolL._AC_SX679_.jpg',
          productPrice: 40.0,
          productLink:
